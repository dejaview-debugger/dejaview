    ...
    with dejaview.patching_context():
        ...
        while True:
            try:
                ...
                t = e.__traceback__
                deepest_tb = t
                while deepest_tb and deepest_tb.tb_next is not None:
                ...
                if socket_client:
                    ...
                    if deepest_tb is not None:
                        socket_client.send_stopped_with_location(
                            "exception",
                            deepest_tb.tb_frame.f_code.co_filename,
                            deepest_tb.tb_lineno,
                        )
                    else:
                        socket_client.send_stopped("exception")
                my_pdb.interaction(None, deepest_tb)
                print(
